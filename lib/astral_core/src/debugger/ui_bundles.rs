...
impl DebugUiIsUpsideDownBundle {
    pub fn new(upside_down: bool, text_style: Option<TextStyle>) -> Self {
        let text = format!("Is Upside Down?: {}", upside_down);
        let text_style = text_style.unwrap_or(DebugUiTextStyle::default());
        Self {
            node: TextBundle::from_section(text, text_style),
            // .with_background_color(Color::rgba(0.8, 0.1, 0.1, 0.2)),
...
// #[derive(Debug, Default, Bundle)]
// pub struct DebugUiCharacterRotationYBundle {
//     pub node: TextBundle,
//     pub ui_component: DebugUiCharacterRotationY,
//     pub label: Label,
// }

// impl DebugUiCharacterRotationYBundle {
//     pub fn new(rotation_y: i8, text_style: Option<TextStyle>) -> Self {
//         let text = format!("Last Rotation Y: {}", rotation_y);
//         let text_style = text_style.unwrap_or(DebugUiTextStyle::default());
//         Self {
//             node: TextBundle::from_section(text, text_style),
//             // .with_background_color(Color::rgba(0.8, 0.1, 0.1, 0.2)),
...
//             //     ..default()
//             // }),
//             ui_component: DebugUiCharacterRotationY,
//             label: Label,
//         }
//     }
// }
...
#[derive(Debug, Default, Bundle)]
pub struct DebugUiCharacterLookAngleBundle {
    pub node: TextBundle,
    pub ui_component: DebugUiCharacterLookAngle,
    pub label: Label,
}

impl DebugUiCharacterLookAngleBundle {
    pub fn new(look_angle: Vec3, text_style: Option<TextStyle>) -> Self {
        let text = format!(
            "Look Angles:\n  x = {}\n  y = {}\n  z = {}",
            look_angle.x, look_angle.y, look_angle.z,
        );
        let text_style = text_style.unwrap_or(DebugUiTextStyle::default());
        Self {
            node: TextBundle::from_section(text, text_style),
            ...
            //     ..default()
            // }),
            ui_component: DebugUiCharacterLookAngle,
            label: Label,
        }
    }
}
